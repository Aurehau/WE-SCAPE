...
$Conf->MENU2='<ul> <li class="deroulant">
            <div class="toggle-dropdown">

                <div class="lienDeroulant"><div class="aventures header-menu1"> Nos aventures </div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FFAE00" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </div>
                <ul class="drop-down">
                    <!--PLACEHOLDER_MENU-->
                </ul>
