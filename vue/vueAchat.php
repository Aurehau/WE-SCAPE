...
<div class="resultat conteneur">
    ...
    <div class="divFacturation">
        ...
        <div class="choix-paiement">
            <h2>Choix de Paiement</h2>
            <div class="recap-total">
                <h3>Récapitulatif du Total</h3>
            ...
            <form>
                <div class="choix-paiement-options">
                    ...
                    <div class="paiementBoutons">
                        ...
                        <label for="carte-bleue">Carte Bleue</label><br>
                    </div>
                    ...
                    <div class="paiementBoutons">
                        ...
                        <label for="cheque-cadeau">Chèque Cadeau</label><br>
                    </div>
        ...
        <div class="divAcheter">
            <a href="index.php?ajouter=ajouter"><button class="bouton" id="submit-btn">Je confirme ma commande</button></a>
        </div>
